...
mapping file: 's3://samsung.ads.data.share/analytics/custom/vaughn/pluto/20240226_pluto_all_sample.csv'
**/
...
's3://samsung.ads.data.share/analytics/custom/vaughn/pluto/20240226_pluto_all_sample.csv'
...
FROM data_ad_xdevice.fact_delivery_event AS fact
WHERE 
    DATE_TRUNC('day', fact.event_time) BETWEEN '2024-02-19' AND '2024-02-25'
...
CREATE TEMP TABLE daily_downloads_table diststyle ALL AS (
    ...
    WHERE 
        ...
        AND partition_date BETWEEN '2024-02-19' AND '2024-02-25'
    GROUP BY 1
);
