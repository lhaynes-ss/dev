...
def get_app_config():
    return {
        ...
        ,'udw_stage_keys': {
            ...
            ,'udw_pplus_us':    {'stage': '@udw_marketing_analytics_reports.paramount_plus_external_us/'} 
            ,'udw_pplus_int':   {'stage': '@udw_marketing_analytics_reports.paramount_plus_external_international/'} 
            ,'udw_pluto_us':    {'stage': '@udw_marketing_analytics_reports.pluto_external_us/'} 
        ...
        ,'destination_bucket_keys': {
            ...
            ,'dev_pplus_us':    {'bucket': 'dev-samsung-dm-data-share-paramount-plus', 'prefix': 'paramount_plus_us/', 'udw_stage': ''}
            ,'dev_pplus_int':   {'bucket': 'dev-samsung-dm-data-share-paramount-plus', 'prefix': 'paramount-plus-international/', 'udw_stage': ''}
            ,'prod_pplus_us':   {'bucket': 'prod-samsung-dm-data-share-paramount-plus', 'prefix': 'paramount_plus_us/', 'udw_stage': 'udw_pplus_us'}
            ...
            ,'dev_pluto_us':    {'bucket': 'dev-samsung-dm-data-share-pluto', 'prefix': 'pluto-us/', 'udw_stage': ''}
            ,'dev_pluto_int':   {'bucket': 'dev-samsung-dm-data-share-pluto', 'prefix': 'pluto-international/', 'udw_stage': ''}
            ,'prod_pluto_us':   {'bucket': 'prod-samsung-dm-data-share-pluto', 'prefix': 'pluto-us/', 'udw_stage': 'udw_pluto_us'}
